...
class PaymentResource extends Resource
{
    ...
    public static function canAccess(): bool                                          { return app(\App\Settings\SettingStore::class)->get('campus_enabled', true) && (auth()->user()?->hasPermissionTo('payments.view') ?? false); }
