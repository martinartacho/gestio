...
Hem rebut una sol·licitud per restablir la contrasenya del vostre compte de **professorat** a **{{ config('app.name') }}**.
...
<x-mail::button :url="route('teacher.password.code')">
Canviar contrasenya
</x-mail::button>
